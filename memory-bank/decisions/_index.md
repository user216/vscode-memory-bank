...
- **ADR-0001**: ADR-0001: Maintain Additive Compatibility with Original memory-bank.instructions.md
- **ADR-0002**: ADR-0002: Use 7-Layer Progressive Enhancement Architecture
- **ADR-0003**: ADR-0003: Use Memory Bank Structure Instead of Separate PRD
- **ADR-0004**: ADR-0004: No Model Version Pinning in Agent Files
- **ADR-0005**: ADR-0005: Agent Identity is Claude Agent Preview, Not Claude Code CLI
