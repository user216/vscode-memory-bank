...
tags: [dependencies, mcp, minisearch]
...
<!-- ASSERT_NOT_CONTAINS: mcp/package.json | better-sqlite3 -->
<!-- ASSERT_CONTAINS: mcp/package.json | minisearch -->
<!-- ASSERT_CONTAINS: mcp/package.json | gray-matter -->
