...
2. Present a structured summary:
   ...
   - **Active Tasks**: in-progress and pending tasks (from tasks/_index.md)
   - **Key Decisions**: recent accepted ADRs (from decisions/_index.md)
3. Flag any inconsistencies between files
4. Ask if context is still accurate
