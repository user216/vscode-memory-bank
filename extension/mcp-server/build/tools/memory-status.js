...
export function registerMemoryStatus(server) {
    server.tool("memory_status", "Returns computed project status: task counts by status, decision counts by status, note counts, and top tags. Use instead of reading progress.md for a quick snapshot.", {}, async () => {
