...
// Parsing
// ---------------------------------------------------------------------------
const ASSERT_RE = /<!--\s*ASSERT_(FILE_EXISTS|FILE_NOT_EXISTS|CONTAINS|NOT_CONTAINS):\s*(.+?)\s*-->/g;
/**
 ...
 */
export function parseAssertions(markdown) {
 ...
 */
export function executeAssertion(assertion, projectRoot) {
 ...
 */
export function verifyAdr(adrFilePath, projectRoot) {
 ...
 */
export function verifyAllDecisions(mbPath, projectRoot) {
    const files = fs
        .readdirSync(mbPath)
 ...
 */
function extractVerificationSection(markdown) {
...
//# sourceMappingURL=verify-assertions.js.map