...
export function registerMemoryCreateNote(server: McpServer): void {
  server.tool(
    "memory_create_note",
    "Create a new note in the memory bank with YAML frontmatter, auto-generated NOTE-NNN ID, and tags. Notes are general-purpose knowledge items (patterns, insights, reference material).",
    {
